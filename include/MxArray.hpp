...
class MxArray
{
  public:
     ...
     * @endcode
     */
    cv::Mat toMat(int depth = -1 /* CV_USRTYPE1 */, bool transpose = true) const;
     ...
     * @endcode
     */
    cv::MatND toMatND(int depth = -1 /* CV_USRTYPE1 */, bool transpose = true) const;
     ...
     */
    cv::SparseMat toSparseMat(int depth = -1 /* CV_USRTYPE1 */) const;
